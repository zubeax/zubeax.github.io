...
Each cluster node has a 500 GB SSD attached via an SATA/USB 3.0 adapter. The SSD serves both as OS disk as well as storage medium for Kubernetes persistent volumes. 
